...
export class AddTvCustomLists1785450000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "custom_list" RENAME TO "custom_list_old"`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `INSERT INTO "custom_list" SELECT * FROM "custom_list_old"`
    );
    await queryRunner.query(`DROP TABLE "custom_list_old"`);
    await queryRunner.query(
